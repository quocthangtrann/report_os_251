...
struct pgd_t
{
	...
	\end{itemize}
	The \texttt{vmap\_page\_range()} function (lines 251-278 of mm64.c) shows how pages are mapped efficiently, tracking mapped pages in the \texttt{fifo\_pgn} list for replacement algorithms.
